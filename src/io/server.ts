...
function serverLogging(tokens: morgan.TokenIndexer, req: express.Request, res: express.Response): string {
	...
	const status = (+statusNum >= 400)? chalk.red(statusNum) : ((+statusNum >= 300)? chalk.green(statusNum) : chalk.blue(statusNum));
